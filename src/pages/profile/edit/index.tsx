import ClassSelect from "~/componets/editProfile/classSelect";
import RoleSelect from "~/componets/editProfile/roleSelect";

export default function EditProfile() {
  return (
    <main className=" flex min-h-screen flex-col items-center justify-center bg-gradient-to-b from-[#026d2b] to-[#114716]">
      <div className="flex">
        <ClassSelect />
        <RoleSelect />
        <svg
